...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        val textAct: TextView=findViewById(R.id.text_action)
        val lemonImage: ImageView=findViewById(R.id.image_lemon_state)

        if(lemonadeState==SELECT){
            textAct.text="Click to select a lemon"
            lemonImage.setImageResource(R.drawable.lemon_tree)
        }else if(lemonadeState==SQUEEZE){
            textAct.text="Click to juice the lemon"
            lemonImage.setImageResource(R.drawable.lemon_squeeze)
        }else if(lemonadeState==DRINK){
            textAct.text="Click to drink the juice"
            lemonImage.setImageResource(R.drawable.lemon_drink)
        }else{
            textAct.text="Click to get a drink again"
